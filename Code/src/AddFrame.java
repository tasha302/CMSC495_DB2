...
public class AddFrame extends JFrame implements ActionListener {
    ...
    private void addOrder() {
    	...
    	statement = "";
    	statement = "insert master.inventory (quantity_onhand, cost, item_id, vendor_id) "
    ...
    private void addSale() {
    	...
    	try {
			...
			rs = DatabaseFactory.executeQuery("select * from master.inventory where item_id=" + itemID);
			while(rs.next()) {
    	...
    	if(quantityAvailable < Integer.parseInt(quantityOrdered)) {
    		...
    		try {
				rs = DatabaseFactory.executeQuery("select * from master.inventory where item_id=" + itemID + " order by item_id");
				while(rs.next()) {
					...
					if(quantityInRecord > totalLeftToPurchase) {
						...
						String statement = "delete from master.inventory where inventory_id=" + Integer.toString(inventoryID);
						DatabaseFactory.executeStatement(statement);
						break;
					}
					else {
